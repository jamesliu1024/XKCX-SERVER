...
//            replyLog.setReceiveTime(LocalDateTime.now());
...
//                replyData.setExpireTime(card.getExpirationTime().toEpochSecond(ZoneOffset.UTC));
...
//            if (card != null) {
//                accessLog.setVisitorId(card.getReservationId());
//            }
...
//            heartbeatLog.setReceiveTime(LocalDateTime.now());
...
//                statusLog.setReceiveTime(LocalDateTime.now());
...
//                    log.warn("Device {} low battery: {}%", deviceId, data.getBattery());
//                }
//                */
//
//                /* 注释掉温度检查
//                if (data.getTemperature() != null && data.getTemperature() > 50) {
//                    log.warn("Device {} high temperature: {}°C", deviceId, data.getTemperature());
//                }
//                */
//
...
//        }
    ...
    public boolean sendEmergencyControl(Integer deviceId, String action, String reason) {
        try {
            ...
            emergencyMessage.setTimestamp(System.currentTimeMillis() / 1000);
